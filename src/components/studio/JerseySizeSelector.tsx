    ...
    <div className="space-y-4">
      ...
      <div className={`p-4 rounded-2xl border space-y-3 ${
        ...
        <div className="flex flex-wrap gap-1.5 pt-0.5">
          ...
          >
            <span className="flex items-center gap-1"><Users className="w-3 h-3 text-brand-400 stroke-[2.5]" /><span>Tim Futsal (12 Pcs)</span></span>
          </button>
          <button
            type="button"
          ...
          >
            <span className="flex items-center gap-1"><Trophy className="w-3 h-3 text-amber-400 stroke-[2.5]" /><span>Sepakbola (18 Pcs)</span></span>
          </button>
          <button
            type="button"
