...
export const StudioSidebar: React.FC<StudioSidebarProps> = ({
  ...
  const toggleLayerVisibility = (id: string) => {
    const updated = currentLayers.map((layer: any) => 
  ...
  return (
    <aside 
      ...
      className={`w-full h-full flex-1 min-h-0 self-stretch rounded-3xl border shadow-2xl overflow-hidden flex flex-col transition-colors duration-200 ${
    ...
    >
      ...
      <div className={`shrink-0 p-3 border-b grid grid-cols-3 gap-2 ${
      ...
      <div className={`shrink-0 px-4 py-3 border-b flex items-center justify-between text-xs ${
      ...
      {/* 3. TAB CONTENT CONTAINER (Spacious Padding & Clean Margins) */}
      <div className="flex-1 min-h-0 p-5 sm:p-6 pb-6 overflow-y-auto space-y-6 custom-scrollbar">
              ...
              {design.referenceImageUrl ? (
                <div className="space-y-2">
                  ...
                  <span className="text-xs font-bold text-emerald-500 flex items-center justify-center gap-1">
                    ...
                    <span>Foto Referensi Terpasang</span>
                  </span>
        ...
        {activeTab === 'layers' && (
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              {currentLayers.map((layer: any, index: number) => (
                <div
                  key={layer.id}
