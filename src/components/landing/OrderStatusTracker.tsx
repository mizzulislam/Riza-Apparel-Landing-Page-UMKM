...
import { ShoppingBag, Search, CheckCircle2, Clock, ShieldCheck, ArrowLeft, RefreshCw, Lock } from 'lucide-react';
  ...
  return (
    <div className={`min-h-screen p-4 sm:p-8 font-sans ${isDark ? 'bg-[#0B0F19] text-white' : 'bg-slate-50 text-slate-900'}`}>
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {!isLoading && orderData && (
          <div className={`p-6 sm:p-8 rounded-3xl border space-y-6 animate-slide-up-fade ${
            ...
            <p className="text-[11px] text-center text-slate-500 flex items-center justify-center gap-1">
              <Lock className="w-3.5 h-3.5 text-emerald-400 shrink-0 stroke-[2.5]" />
              <span>Privasi Terjamin: Halaman ini hanya menampilkan data status pesanan publik tanpa nomor telepon atau informasi sensitif.</span>
            </p>
